...
// touch toggles on tap. See app/components/Interactivity.tsx.
const reels = [
  {
...
export default function Page() {
  return (
    <>
      ...
      <section className="tl-section" id="explore" data-reveal>
      ...
      {/* ABOUT SNIPPET */}
      <section className="tl-section tl-bg-sand" id="about" data-reveal>
      ...
      {/* IG STRIP */}
      <section className="tl-section" aria-label="Instagram feed" data-reveal>
      ...
      {/* COLLABS QUIET STRIP */}
      <section className="tl-collab-strip" id="collabs" data-reveal>
